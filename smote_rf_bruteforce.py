#!/usr/bin/env python
# Created by "Thieu" at 14:42, 25/10/2022 ----------%                                                                               
...
for idx, features in enumerate(list_all_features):
    ...
    param_grid = {'n_estimators': list(range(10, 210, 10))}
    ...
    mm = {**mm0, **mm1, **mm2}
    save_results_to_csv(mm, f"smote-rf-tuning-results_mean_threshold", "data/history")
