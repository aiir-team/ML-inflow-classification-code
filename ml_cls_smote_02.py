...
# 0.5 - 8, 10, 7, 1
key_features = "SVM-FS"
selected_features_idx, selected_features_score = select_cls_features(X_train_scaled, y_train, mi_weight=0, anova_weight=0, dt_weight=0, rf_weight=0,
                                                                     svm_weight=1)
X_train_scaled = X_train_scaled[:, selected_features_idx[selected_features_score>0.5]]
X_test_scaled = X_test_scaled[:, selected_features_idx[selected_features_score>0.5]]
