...
list_models = [
    {
        ...
        "param_grid": Config.RF_RF_GRID
    }, {
        "name": "SVM",
        "model": SVR(),
        "param_grid": Config.RF_SVM_GRID
    }, {
        "name": "LR",
        "model": LinearRegression(),
        "param_grid": Config.RF_LR_GRID
    }, {
        "name": "KNN",
        "model": KNeighborsRegressor(),
        "param_grid": Config.RF_KNN_GRID
    }, {
        "name": "DT",
        "model": DecisionTreeRegressor(random_state=Config.SEED),
        "param_grid": Config.RF_DT_GRID
    }, {
        "name": "AdaBoost",
        "model": AdaBoostRegressor(random_state=Config.SEED),
        "param_grid": Config.RF_AdaBoost_GRID
    }, {
        "name": "MLP",
        "model": MLPRegressor(random_state=Config.SEED),
        "param_grid": Config.RF_MLP_GRID
    }
]
