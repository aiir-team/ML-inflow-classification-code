...
## Select features
key_features = "SVM-FS"
selected_features_idx, selected_features_score = select_cls_features(X_train_scaled, y_train, mi_weight=0, anova_weight=0, dt_weight=0, rf_weight=0, svm_weight=1)
